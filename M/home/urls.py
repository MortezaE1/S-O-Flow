...
urlpatterns = [
    ...
    path('reply/<int:post_id>/<int:comment_id>/', views.PostAddReplyView.as_view(), name='reply_comment'),
    path('like/<int:post_id>/<slug:post_slug>/', views.LikePostView.as_view(), name='like_post'),
]