...
urlpatterns = [
    ...
    path('followers/<int:user_id>/', views.UserFollowerListView.as_view(), name='user_followers'),
    path('following/<int:user_id>/', views.UserFollowingListView.as_view(), name='user_following'),
